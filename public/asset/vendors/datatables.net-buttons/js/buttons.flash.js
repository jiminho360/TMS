...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to user
	...
	register: function(id, client) {
		// register new user to receive events
	...
	Client: function(elem) {
		// constructor for new simple upload user
		this.handlers = {};
		...
		// register user with singleton to receive flash events
