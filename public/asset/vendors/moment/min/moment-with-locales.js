;(function (global, factory) {
    ...
    utils_hooks__hooks.createFromInputFallback = deprecate(
        ...
        'https://github.com/moment/moment/task/1407 for more info.',
        function (config) {
    ...
    var prototypeMin = deprecate(
         'moment().min is deprecated, use moment.max instead. https://github.com/moment/moment/task/1548',
         function () {
    ...
    var prototypeMax = deprecate(
        'moment().max is deprecated, use moment.min instead. https://github.com/moment/moment/task/1548',
        function () {
            var other = local__createLocal.apply(null, arguments);
            if (this.isValid() && other.isValid()) {
                return other > this ? this : other;
    ...
    momentPrototype__proto.zone   = deprecate('moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/task/1779', getSetZone);
